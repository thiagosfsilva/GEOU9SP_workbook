...
The `Statisitcal Summary Tool` (![](https://docs.qgis.org/3.34/en/_images/mActionSum.png)) is a quick way to summarise attribute values, and can be quite powerful when combined with attribute selections. 
...
Good job, we have now finished our first guided tour of vector attributes. We will revsit it in the next lab, when we also learn about geometry-based selections. 
