...
(@) Organize the layer order and play with different layer superpositions to make the most readable visualisation for all datasets involved. Then experiment with the *symbology* of each layer to improve your visualization (Right-click on the layer name then `Properties > Symbology`).
