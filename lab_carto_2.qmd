...
(@) No we need a new empty layer to digitise on. Click on the `New shapefile layer` button (![](https://docs.qgis.org/3.34/en/_images/mActionNewVectorLayer.png) ) on the main QGIS toolbar. You  will get the `New Shapefile Layer` window:
