...
(@) Head to the [Digimap](https://digimap.edina.ac.uk/) website, and if you haven't already, make sure you accept the user licenses for all datasets, as show on the instructions video available on Canvas.
...
::: {.callout-note}
Each of the download datasets will contain several files once you unzip them. All of them are important, so make sure to keep them all together (except for the text files, these can go somewhere else).
::: 
...
As the module progresses, the independent exercises will give you less and less directions, to reflect real-world GIS usage. **Don't skipe the independent exercises**  - it is easy to fall into a false sense of '*I got this*' when only following step-by-step directions. 
